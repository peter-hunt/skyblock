...
You type commands to play the game. Many mechanics and content are different from the original Hypixel Skyblock, but I'm trying to make it as close to the original Hypixel Skyblock as possible.
...
# Screenshots
Here's some footage on the Skyblock Remake's gameplay:
