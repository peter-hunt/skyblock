...
HUB_JOINTS = [
    ...
    COLOSSEUM, COMMUNITY_CENTER, CRYPT, DARK_AUCTION, FARM, FARMHOUSE, FASHION_SHOP,
    FLOWER_HOUSE, FOREST, GRAVEYARD, HIGH_LEVEL, HUB_CASTLE, CRYPT, LIBRARY, MOUNTAIN,
    PETS_BUILDING, POTION_SHOP, RUINS, TAVERN, VILLAGE, WILDERNESS, WIZARD_TOWER,
]
