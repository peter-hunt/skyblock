...
COLL_ALTER = {
    ...
    'enchanted_coal_block': ('coal', 25600),
    'enchanted_iron': ('iron', 160),
    'enchanted_iron_block': ('iron', 25600),
    'enchanted_gold': ('gold', 160),
    'enchanted_gold_block': ('gold', 25600),
    'enchanted_diamond': ('diamond', 160),
    'enchanted_diamond_block': ('diamond', 25600),
    'enchanted_lapis': ('lapis', 160),
    'enchanted_lapis_block': ('lapis', 25600),
    'enchanted_emerald': ('emerald', 160),
    'enchanted_emerald_block': ('emerald', 25600),
    'enchanted_redstone': ('redstone', 160),
    'enchanted_redstone_block': ('redstone', 25600),
    'enchanted_quartz': ('quartz', 160),
    'enchanted_quartz_block': ('quartz', 25600),
    'enchanted_obsidian': ('obsidian', 160),
    'enchanted_glowstone': ('glowstone', 160),
    'enchanted_glowstone_block': ('glowstone', 25600),
    'enchanted_flint': ('gravel', 25600),
    'enchanted_ice': ('ice', 160),
    'enchanted_packed_ice': ('ice', 25600),
    ...
    'enchanted_slime_block': ('slime_ball', 25600),
    'enchanted_blaze_powder': ('blaze_rod', 160),
    'enchanted_blaze_rod': ('blaze_rod', 25600),
    ...
    'enchanted_cooked_fish': ('fish', 25600),
    'enchanted_salmon': ('salmon', 160),
    'enchanted_cooked_salmon': ('salmon', 25600),
