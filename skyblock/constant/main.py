...
COLL_ALTER = {
    ...
    'tightly_tied_hay_bale': ('wheat', 186624),
    'enchanted_carrot': ('carrot', 160),
    'enchanted_potato': ('potato', 160),
    'enchanted_baked_potato': ('potato', 25_600),
    'enchanted_pumpkin': ('pumpkin', 160),
    'polished_pumpkin': ('pumpkin', 25_600),
    'enchanted_melon': ('melon', 160),
    'enchanted_melon_block': ('melon', 25_600),
    'enchanted_mushroom': ('mushroom', 160),
    'enchanted_mushroom_block': ('mushroom', 25_600),
    'enchanted_cocoa': ('cocoa', 160),
    'enchanted_cactus_green': ('cactus', 160),
    'enchanted_cactus': ('cactus', 25_600),
    'enchanted_sugar': ('sugar_cane', 160),
    'enchanted_sugar_cane': ('sugar_cane', 25_600),
    'enchanted_feather': ('feather', 160),
    'enchanted_leather': ('leather', 160),
    'enchanted_pork': ('pork', 160),
    'enchanted_grilled_pork': ('pork', 25_600),
    'enchanted_chicken': ('chicken', 160),
    'enchanted_egg': ('egg', 144),
    'super_enchanted_egg': ('egg', 20736),
    'enchanted_mutton': ('mutton', 160),
    'enchanted_cooked_mutton': ('mutton', 25_600),
    'enchanted_rabbit': ('rabbit', 160),
    'enchanted_nether_wart': ('nether_wart', 160),
    'mutant_nether_wart': ('nether_wart', 25_600),
    ...
    'packed_ice': ('ice', 9),
    'glowstone_block': ('glowstone', 4),

    'enchanted_cobblestone': ('cobblestone', 160),
    'enchanted_coal': ('coal', 160),
    'enchanted_coal_block': ('coal', 25_600),
    'enchanted_iron': ('iron', 160),
    'enchanted_iron_block': ('iron', 25_600),
    'enchanted_gold': ('gold', 160),
    'enchanted_gold_block': ('gold', 25_600),
    'enchanted_diamond': ('diamond', 160),
    'enchanted_diamond_block': ('diamond', 25_600),
    'enchanted_lapis': ('lapis', 160),
    'enchanted_lapis_block': ('lapis', 25_600),
    'enchanted_emerald': ('emerald', 160),
    'enchanted_emerald_block': ('emerald', 25_600),
    'enchanted_redstone': ('redstone', 160),
    'enchanted_redstone_block': ('redstone', 25_600),
    'enchanted_quartz': ('quartz', 160),
    'enchanted_quartz_block': ('quartz', 25_600),
    'enchanted_obsidian': ('obsidian', 160),
    'enchanted_glowstone': ('glowstone', 160),
    'enchanted_glowstone_block': ('glowstone', 25_600),
    'enchanted_flint': ('gravel', 25_600),
    'enchanted_ice': ('ice', 160),
    'enchanted_packed_ice': ('ice', 25_600),
    'enchanted_netherrack': ('netherrack', 160),
    'enchanted_sand': ('sand', 160),
    'enchanted_end_stone': ('end_stone', 160),
    'enchanted_mithril': ('mithril', 160),
    'enchanted_mycelium': ('mycelium', 160),
    'enchanted_mycelium_cube': ('mycelium', 25_600),
    'enchanted_red_sand': ('red_sand', 160),
    'enchanted_red_sand_cube': ('red_sand', 25_600),
    'enchanted_hard_stone': ('hard_stone', 576),
    'concentrated_stone': ('hard_stone', 331_776),

    'rough_ruby_gemstone': ('gemstone', 1),
    'rough_amber_gemstone': ('gemstone', 1),
    'rough_sapphire_gemstone': ('gemstone', 1),
    'rough_jade_gemstone': ('gemstone', 1),
    'rough_amethyst_gemstone': ('gemstone', 1),
    'rough_topaz_gemstone': ('gemstone', 1),
    'rough_jasper_gemstone': ('gemstone', 1),
    'rough_opal_gemstone': ('gemstone', 1),
    'flawed_ruby_gemstone': ('gemstone', 80),
    'flawed_amber_gemstone': ('gemstone', 80),
    'flawed_sapphire_gemstone': ('gemstone', 80),
    'flawed_jade_gemstone': ('gemstone', 80),
    'flawed_amethyst_gemstone': ('gemstone', 80),
    'flawed_topaz_gemstone': ('gemstone', 80),
    'flawed_jasper_gemstone': ('gemstone', 80),
    'flawed_opal_gemstone': ('gemstone', 80),
    'fine_ruby_gemstone': ('gemstone', 6_400),
    'fine_amber_gemstone': ('gemstone', 6_400),
    'fine_sapphire_gemstone': ('gemstone', 6_400),
    'fine_jade_gemstone': ('gemstone', 6_400),
    'fine_amethyst_gemstone': ('gemstone', 6_400),
    'fine_topaz_gemstone': ('gemstone', 6_400),
    'fine_jasper_gemstone': ('gemstone', 6_400),
    'fine_opal_gemstone': ('gemstone', 6_400),
    'flawless_ruby_gemstone': ('gemstone', 512_000),
    'flawless_amber_gemstone': ('gemstone', 512_000),
    'flawless_sapphire_gemstone': ('gemstone', 512_000),
    'flawless_jade_gemstone': ('gemstone', 512_000),
    'flawless_amethyst_gemstone': ('gemstone', 512_000),
    'flawless_topaz_gemstone': ('gemstone', 512_000),
    'flawless_jasper_gemstone': ('gemstone', 512_000),
    'flawless_opal_gemstone': ('gemstone', 512_000),
    'perfect_ruby_gemstone': ('gemstone', 40_960_000),
    'perfect_amber_gemstone': ('gemstone', 40_960_000),
    'perfect_sapphire_gemstone': ('gemstone', 40_960_000),
    'perfect_jade_gemstone': ('gemstone', 40_960_000),
    'perfect_amethyst_gemstone': ('gemstone', 40_960_000),
    'perfect_topaz_gemstone': ('gemstone', 40_960_000),
    'perfect_jasper_gemstone': ('gemstone', 40_960_000),
    'perfect_opal_gemstone': ('gemstone', 40_960_000),

    'slime_block': ('slime_ball', 9),
    'enchanted_rotten_flesh': ('rotten_flesh', 160),
    'enchanted_bone': ('bone', 160),
    'enchanted_string': ('string', 160),
    'enchanted_spider_eye': ('spider_eye', 160),
    'enchanted_gunpowder': ('gunpowder', 160),
    'enchanted_ender_pearl': ('ender_pearl', 160),
    'enchanted_ghast_tear': ('ghast_tear', 5),
    'silver_fang': ('ghast_tear', 125),
    'enchanted_slime_ball': ('slime_ball', 160),
    'enchanted_slime_block': ('slime_ball', 25_600),
    'enchanted_blaze_powder': ('blaze_rod', 160),
    'enchanted_blaze_rod': ('blaze_rod', 25_600),
    'enchanted_magma_cream': ('magma_cream', 160),

    'enchanted_oak': ('oak_wood', 160),
    'enchanted_birch': ('birch_wood', 160),
    'enchanted_spruce': ('spruce_wood', 160),
    'enchanted_dark_oak': ('dark_oak_wood', 160),
    'enchanted_acacia': ('acacia_wood', 160),
    'enchanted_jungle': ('jungle_wood', 160),

    'enchanted_fish': ('fish', 160),
    'enchanted_cooked_fish': ('fish', 25_600),
    'enchanted_salmon': ('salmon', 160),
    'enchanted_cooked_salmon': ('salmon', 25_600),
    'enchanted_pufferfish': ('pufferfish', 160),
    'enchanted_prismarine_shard': ('prismarine_shard', 160),
    'enchanted_prismarine_crystals': ('prismarine_crystals', 160),
    'enchanted_clay': ('clay', 160),
    'enchanted_lily_pad': ('lily_pad', 160),
    'enchanted_ink_sack': ('ink_sack', 160),
...
INTEREST_TABLE = {
    ...
    'luxurious': [
        ...
        (30_000_000, 50_000_000, 0.002),
        (50_000_000, 160_000_000, 0.001),
        (160_000_000, 5_100_000_000, 0.0001)],
    'palatial': [
        (0, 10_000_000, 0.02),
        (10_000_000, 20_000_000, 0.01),
        (20_000_000, 30_000_000, 0.005),
        ...
        (50_000_000, 160_000_000, 0.001),
        (160_000_000, 5_100_000_000, 0.0001),
        (5_100_000_000, 55_000_000_000, 0.00001)]}
...
SELL_PRICE = {
    ...
    'holy_dragon_fragment': 2_500,
    'old_dragon_fragment': 2_500,
    'protector_dragon_fragment': 2_500,
    'unstable_dragon_fragment': 2_500,
    'young_dragon_fragment': 2_500,
    'strong_dragon_fragment': 15_000,
    'wise_dragon_fragment': 15_000,
    'superior_dragon_fragment': 100_000,
    'summoning_eye': 1_000_000,
    ...
    'rosettas_helmet': 525,
    'rosettas_chestplate': 660,
    'rosettas_leggings': 600,
    'rosettas_boots': 480,
    'squire_sword': 2_500,
    'squire_helmet': 2_500,
    'squire_chestplate': 4_000,
    'squire_leggings': 3_500,
    'squire_boots': 2_000,
    'celeste_helmet': 2_500,
    'celeste_chestplate': 4_000,
    'celeste_leggings': 3_500,
    'celeste_boots': 2_000,
    'mercenary_axe': 15_000,
    'mercenary_helmet': 17_500,
    'mercenary_chestplate': 35_000,
    'mercenary_leggings': 22_500,
    'mercenary_boots': 15_000,
    'starlight_helmet': 17_500,
    'starlight_chestplate': 35_000,
    'starlight_leggings': 22_500,
    'starlight_boots': 15_000,
...
KILL_LEVELS = (
    10, 15, 75, 150, 250, 500, 1500, 2500, 5000, 15000, 25000, 50000
)
