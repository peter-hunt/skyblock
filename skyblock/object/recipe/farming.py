...
FARMING_RECIPES = [
    ...
    Recipe('harvesting_book', 'farming',
           [(Item('paper'), 48),
            (Item('wheat'), 16)],
           (EnchantedBook(enchantments={'harvesting': 4}), 1),
    ...
    Recipe('cubism_book', 'farming',
           [(Item('paper'), 24),
            (Item('pumpkin'), 32)],
           (EnchantedBook(enchantments={'cubism': 4}), 1),
    ...
    Recipe('projectile_protection_book', 'farming',
           [(Item('paper'), 24),
            (Item('arrow'), 8)],
           (EnchantedBook(enchantments={'projectile_protection': 4}), 1),
    ...
    Recipe('luck_book', 'farming',
           [(Item('paper'), 24),
            (Item('rabbit_hide'), 8)],
           (EnchantedBook(enchantments={'luck': 4}), 1),
    ...
    Recipe('luck_of_the_sea_book', 'farming',
           [(Item('paper'), 24),
            (Item('rabbit_foot'), 16)],
           (EnchantedBook(enchantments={'luck_of_the_sea': 4}), 1),
