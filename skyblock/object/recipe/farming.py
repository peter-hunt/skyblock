...
FARMING_RECIPES = [
    ...
    Recipe('vaccine_talisman', 'farming',
           [(Item('poisonous_potato'), 9)],
           (get_item('vaccine_talisman'), 1),
    ...
    Recipe('speed_ring', 'farming',
           [(Item('speed_talisman'), 1),
            (Item('enchanted_sugar'), 96)],
           (get_item('speed_ring'), 1),
           collection_req=('sugar_cane', 5)),
    ...
    Recipe('speed_artifact', 'farming',
           [(Item('speed_ring'), 1),
            (Item('enchanted_sugar_cane'), 48)],
           (get_item('speed_artifact'), 1),
           collection_req=('sugar_cane', 8)),
    ...
    Recipe('feather_ring', 'farming',
           [(Item('feather_talisman'), 1),
            (Item('enchanted_feather'), 7)],
           (get_item('feather_ring'), 1),
           collection_req=('feather', 7)),
    Recipe('feather_artifact', 'farming',
           [(Item('feather_ring'), 1),
            (Item('enchanted_feather'), 128)],
           (get_item('feather_artifact'), 1),
    ...
    Recipe('mutton_to_enchanted_cooked', 'farming',
           ...
           (Item('enchanted_cooked_mutton'), 1),
