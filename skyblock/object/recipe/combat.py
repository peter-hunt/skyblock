...
COMBAT_RECIPES = [
    ...
    Recipe('smite_book', 'combat',
           [(Item('paper'), 24),
            (Item('rotten_flesh'), 8)],
           (EnchantedBook(enchantments={'smite': 4}), 1),
    ...
    Recipe('power_book', 'combat',
           [(Item('paper'), 24),
            (Item('bone'), 40)],
           (EnchantedBook(enchantments={'power': 4}), 1),
    ...
    Recipe('infinite_quiver_book', 'combat',
           [(Item('paper'), 24),
            (Item('bow'), 1)],
           (EnchantedBook(enchantments={'infinite_quiver': 4}), 1),
    ...
    Recipe('bane_of_arthropods_book', 'combat',
           [(Item('paper'), 24),
            (Item('spider_eye'), 8)],
           (EnchantedBook(enchantments={'bane_of_arthropods': 4}), 1),
    ...
    Recipe('blast_protection_book', 'combat',
           [(Item('paper'), 24),
            (Item('gunpowder'), 8)],
           (EnchantedBook(enchantments={'blast_protection': 4}), 1),
    ...
    Recipe('thunderlord_book', 'combat',
           ...
           (EnchantedBook(enchantments={'thunderlord': 4}), 1),
    ...
    Recipe('ender_slayer_book', 'combat',
           ...
           (EnchantedBook(enchantments={'ender_slayer': 4}), 1),
    ...
    Recipe('giant_killer_book', 'combat',
           [(Item('paper'), 24),
            (Item('ghast_tear'), 8)],
           (EnchantedBook(enchantments={'giant_killer': 4}), 1),
    ...
    Recipe('vampirism_book', 'combat',
           ...
           (EnchantedBook(enchantments={'vampirism': 4}), 1),
    ...
    Recipe('knockback_book', 'combat',
           [(Item('paper'), 3),
            (Item('slime_ball'), 3)],
           (EnchantedBook(enchantments={'knockback': 1}), 1),
    ...
    Recipe('punch_book', 'combat',
           [(Item('paper'), 3),
            (Item('slime_ball'), 1),
            (Item('arrow'), 1)],
           (EnchantedBook(enchantments={'punch': 1}), 1),
    ...
    Recipe('fire_aspect_book', 'combat',
           [(Item('paper'), 3),
            (Item('blaze_rod'), 4)],
           (EnchantedBook(enchantments={'fire_aspect': 1}), 1),
    ...
    Recipe('flame_book', 'combat',
           [(Item('paper'), 3),
            (Item('blaze_rod'), 2),
            (Item('bow'), 1)],
           (EnchantedBook(enchantments={'flame': 1}), 1),
    ...
    Recipe('fire_protection_book', 'combat',
           [(Item('paper'), 24),
            (Item('magma_cream'), 8)],
           (EnchantedBook(enchantments={'fire_protection': 4}), 1),
