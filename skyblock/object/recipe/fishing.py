...
FISHING_RECIPES = [
    ...
    Recipe('lure_book', 'fishing',
           [(Item('paper'), 24),
            (Item('salmon'), 8)],
           (EnchantedBook(enchantments={'lure': 4}), 1),
    ...
    Recipe('magnet_book', 'fishing',
           [(Item('paper'), 24),
            (Item('clownfish'), 8),
            (Item('quartz'), 8)],
           (EnchantedBook(enchantments={'magnet': 4}), 1),
    ...
    Recipe('cleave_book', 'fishing',
           [(Item('paper'), 24),
            (Item('pufferfish'), 40)],
           (EnchantedBook(enchantments={'cleave': 4}), 1),
    ...
    Recipe('spiked_hook_book', 'fishing',
           [(Item('paper'), 24),
            (Item('pufferfish'), 64),
            (Item('gravel'), 40)],
           (EnchantedBook(enchantments={'spiked_hook': 4}), 1),
           collection_req=('pufferfish', 6)),

    Recipe('impaling_book', 'fishing',
           [(Item('paper'), 6),
            (Item('prismarine_shard'), 20)],
           (EnchantedBook(enchantments={'impaling': 2}), 1),
    ...
    Recipe('blessing_book', 'fishing',
           [(Item('paper'), 24),
            (Item('enchanted_pufferfish'), 8),
            (Item('gold_block'), 64)],
           (EnchantedBook(enchantments={'blessing': 4}), 1),
    ...
    Recipe('frail_book', 'fishing',
           [(Item('paper'), 24),
            (Item('pufferfish'), 64),
            (Item('lily_pad'), 40)],
           (EnchantedBook(enchantments={'frail': 4}), 1),
    ...
    Recipe('caster_book', 'fishing',
           [(Item('paper'), 24),
            (Item('whale_bait'), 8),
            (Item('lily_pad'), 8)],
           (EnchantedBook(enchantments={'caster': 4}), 1),
           collection_req=('ink_sack', 5)),
    Recipe('angler_book', 'fishing',
           [(Item('paper'), 24),
            (Item('ink_sack'), 32)],
           (EnchantedBook(enchantments={'angler': 4}), 1),
