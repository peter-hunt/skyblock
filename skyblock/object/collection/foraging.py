...
FORAGING_COLLECTIONS = [
    Collection(
        ...
        [(50, 5),
         ...
         (250, (get_recipe('leaflet_helmet'), get_recipe('leaflet_chestplate'),
                get_recipe('leaflet_leggings'), get_recipe('leaflet_boots'))),
         (500, 50),
         (1_000, 100),
    ...
    Collection(
        ...
        [(50, 5),
         ...
         (10_000, 1_000),
         (25_000, 2_500),
         (50_000, (get_recipe('growth_helmet'), get_recipe('growth_chestplate'),
                   get_recipe('growth_leggings'), get_recipe('growth_boots')))]),
    Collection(
